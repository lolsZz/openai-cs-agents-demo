  ...
  return {
    tools: [
          ...
          properties: {
            customer_info: {
              ...
              properties: {
                ...
                confirmation: { type: 'string', description: 'Confirmation number' },
                flight: { type: 'string', description: 'Flight number' },
                seat: { type: 'string', description: 'Current seat number' }
              },
      ...
      },
      {
        ...
        description: 'Send a message to the agent orchestra and get intelligent routing and responses',
        inputSchema: {
          type: 'object',
          properties: {
            session_id: {
      ...
      },
      {
        ...
        description: 'Get current session status, active agent, and conversation context',
        inputSchema: {
          type: 'object',
          properties: {
            session_id: {
      ...
      },
      {
        ...
        description: 'Manually trigger a handoff to a specific agent',
        inputSchema: {
          type: 'object',
          properties: {
            session_id: {
      ...
      },
      {
        ...
        description: 'Test the guardrail system with a message',
        inputSchema: {
          type: 'object',
          properties: {
            message: {
